...
type EvalStates struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	States        map[string]*EvalState  `protobuf:"bytes,1,rep,name=states,proto3" json:"states,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Telemetry) GetLinkStats() *LinkStatsData {
	if x != nil {
		if x, ok := x.Data.(*Telemetry_LinkStats); ok {
			return x.LinkStats
		}
	}
	return nil
...
func (x *Telemetry) GetAttitude() *AttitudeData {
	if x != nil {
		if x, ok := x.Data.(*Telemetry_Attitude); ok {
			return x.Attitude
		}
	}
	return nil
...
func (x *Telemetry) GetBattery() *BatteryData {
	if x != nil {
		if x, ok := x.Data.(*Telemetry_Battery); ok {
			return x.Battery
		}
	}
	return nil
...
func (x *Telemetry) GetGps() *GPSData {
	if x != nil {
		if x, ok := x.Data.(*Telemetry_Gps); ok {
			return x.Gps
		}
	}
	return nil
...
func (x *Telemetry) GetFlightMode() *FlightModeData {
	if x != nil {
		if x, ok := x.Data.(*Telemetry_FlightMode); ok {
			return x.FlightMode
		}
	}
	return nil
...
func (x *Telemetry) GetSync() *SyncData {
	if x != nil {
		if x, ok := x.Data.(*Telemetry_Sync); ok {
			return x.Sync
		}
	}
	return nil
...
func (x *Telemetry) GetLinkTx() *LinkTXData {
	if x != nil {
		if x, ok := x.Data.(*Telemetry_LinkTx); ok {
			return x.LinkTx
		}
	}
	return nil
...
func (x *Telemetry) GetLinkRx() *LinkRXData {
	if x != nil {
		if x, ok := x.Data.(*Telemetry_LinkRx); ok {
			return x.LinkRx
		}
	}
	return nil
...
func (x *Telemetry) GetBarometer() *BarometerData {
	if x != nil {
		if x, ok := x.Data.(*Telemetry_Barometer); ok {
			return x.Barometer
		}
	}
	return nil
...
func (x *Telemetry) GetVariometer() *VariometerData {
	if x != nil {
		if x, ok := x.Data.(*Telemetry_Variometer); ok {
			return x.Variometer
		}
	}
	return nil
...
func (x *Telemetry) GetBarometerVariometer() *BarometerVariometerData {
	if x != nil {
		if x, ok := x.Data.(*Telemetry_BarometerVariometer); ok {
...
func (x *Telemetry) GetDeviceInfo() *CRSFDeviceInfoData {
	if x != nil {
		if x, ok := x.Data.(*Telemetry_DeviceInfo); ok {
			return x.DeviceInfo
		}
	}
	return nil
...
func (x *Telemetry) GetDeviceFieldEntry() *CRSFDeviceFieldEntryData {
	if x != nil {
		if x, ok := x.Data.(*Telemetry_DeviceFieldEntry); ok {
...
func (x *Telemetry) GetDeviceField() *CRSFDeviceFieldData {
	if x != nil {
		if x, ok := x.Data.(*Telemetry_DeviceField); ok {
...
func (x *Telemetry) GetDeviceLinkStatus() *CRSFDeviceLinkStatusData {
	if x != nil {
		if x, ok := x.Data.(*Telemetry_DeviceLinkStatus); ok {
...
func (x *CRSFDeviceFieldData) GetData() isCRSFDeviceFieldData_Data {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *CRSFDeviceFieldData) GetUint8() *CRSFDeviceFieldUint8 {
	if x != nil {
		if x, ok := x.Data.(*CRSFDeviceFieldData_Uint8); ok {
			return x.Uint8
		}
	}
	return nil
...
func (x *CRSFDeviceFieldData) GetInt8() *CRSFDeviceFieldInt8 {
	if x != nil {
		if x, ok := x.Data.(*CRSFDeviceFieldData_Int8); ok {
			return x.Int8
		}
	}
	return nil
...
func (x *CRSFDeviceFieldData) GetUint16() *CRSFDeviceFieldUint16 {
	if x != nil {
		if x, ok := x.Data.(*CRSFDeviceFieldData_Uint16); ok {
			return x.Uint16
		}
	}
	return nil
...
func (x *CRSFDeviceFieldData) GetInt16() *CRSFDeviceFieldInt16 {
	if x != nil {
		if x, ok := x.Data.(*CRSFDeviceFieldData_Int16); ok {
			return x.Int16
		}
	}
	return nil
...
func (x *CRSFDeviceFieldData) GetUint32() *CRSFDeviceFieldUint32 {
	if x != nil {
		if x, ok := x.Data.(*CRSFDeviceFieldData_Uint32); ok {
			return x.Uint32
		}
	}
	return nil
...
func (x *CRSFDeviceFieldData) GetInt32() *CRSFDeviceFieldInt32 {
	if x != nil {
		if x, ok := x.Data.(*CRSFDeviceFieldData_Int32); ok {
			return x.Int32
		}
	}
	return nil
...
func (x *CRSFDeviceFieldData) GetUint64() *CRSFDeviceFieldUint64 {
	if x != nil {
		if x, ok := x.Data.(*CRSFDeviceFieldData_Uint64); ok {
			return x.Uint64
		}
	}
	return nil
...
func (x *CRSFDeviceFieldData) GetInt64() *CRSFDeviceFieldInt64 {
	if x != nil {
		if x, ok := x.Data.(*CRSFDeviceFieldData_Int64); ok {
			return x.Int64
		}
	}
	return nil
...
func (x *CRSFDeviceFieldData) GetFloat() *CRSFDeviceFieldFloat {
	if x != nil {
		if x, ok := x.Data.(*CRSFDeviceFieldData_Float); ok {
			return x.Float
		}
	}
	return nil
...
func (x *CRSFDeviceFieldData) GetTextSelect() *CRSFDeviceFieldTextSelect {
	if x != nil {
		if x, ok := x.Data.(*CRSFDeviceFieldData_TextSelect); ok {
			return x.TextSelect
		}
	}
	return nil
...
func (x *CRSFDeviceFieldData) GetString_() *CRSFDeviceFieldString {
	if x != nil {
		if x, ok := x.Data.(*CRSFDeviceFieldData_String_); ok {
			return x.String_
		}
	}
	return nil
...
func (x *CRSFDeviceFieldData) GetFolder() *CRSFDeviceFieldFolder {
	if x != nil {
		if x, ok := x.Data.(*CRSFDeviceFieldData_Folder); ok {
			return x.Folder
		}
	}
	return nil
...
func (x *CRSFDeviceFieldData) GetInfo() *CRSFDeviceFieldInfo {
	if x != nil {
		if x, ok := x.Data.(*CRSFDeviceFieldData_Info); ok {
			return x.Info
		}
	}
	return nil
...
func (x *CRSFDeviceFieldData) GetCommand() *CRSFDeviceFieldCommand {
	if x != nil {
		if x, ok := x.Data.(*CRSFDeviceFieldData_Command); ok {
			return x.Command
		}
	}
	return nil
...
const file_server_proto_rawDesc = "" +
	"\n" +
	"\fserver.proto\x12\x0fJoystickControl\x1a\x1cgoogle/protobuf/struct.proto\"\a\n" +
	"\x05Empty\"\x81\x01\n" +
	"\x0fValidationError\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage\x12\x1a\n" +
	"\blocation\x18\x02 \x01(\tR\blocation\x128\n" +
	"\x06causes\x18\x03 \x03(\v2 .JoystickControl.ValidationErrorR\x06causes\"U\n" +
	"\x11GetTransmitterRes\x12@\n" +
	"\ftransmitters\x18\x01 \x03(\v2\x1c.JoystickControl.TransmitterR\ftransmitters\"5\n" +
	"\vTransmitter\x12\x12\n" +
	"\x04port\x18\x01 \x01(\tR\x04port\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\"L\n" +
	"\x10ValidationErrors\x128\n" +
	"\x06errors\x18\x01 \x03(\v2 .JoystickControl.ValidationErrorR\x06errors\"F\n" +
	"\x0eGetGamepadsRes\x124\n" +
	"\bgamepads\x18\x01 \x03(\v2\x18.JoystickControl.GamepadR\bgamepads\"o\n" +
	"\aGamepad\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x12\n" +
	"\x04axes\x18\x03 \x01(\x05R\x04axes\x12\x18\n" +
	"\abuttons\x18\x04 \x01(\x05R\abuttons\x12\x12\n" +
	"\x04hats\x18\x05 \x01(\x05R\x04hats\"?\n" +
	"\fGetConfigRes\x12/\n" +
	...
	"\x11ValidateConfigRes\x12\x16\n" +
	"\x06errors\x18\x01 \x03(\tR\x06errors\x12\x1a\n" +
	"\bwarnings\x18\x02 \x03(\tR\bwarnings\"?\n" +
	"\fStartLinkReq\x12\x12\n" +
	"\x04port\x18\x01 \x01(\tR\x04port\x12\x1b\n" +
	"\tbaud_rate\x18\x02 \x01(\x05R\bbaudRate\"I\n" +
	"\x13GetGamepadStreamReq\x122\n" +
	"\agamepad\x18\x01 \x01(\v2\x18.JoystickControl.GamepadR\agamepad\"v\n" +
	"\x11GamepadInputState\x125\n" +
	"\x04type\x18\x01 \x01(\x0e2!.JoystickControl.GamepadInputTypeR\x04type\x12\x14\n" +
	"\x05index\x18\x02 \x01(\x05R\x05index\x12\x14\n" +
	"\x05value\x18\x03 \x01(\x05R\x05value\"^\n" +
	"\x13GamepadInputsStates\x12G\n" +
	"\rinputs_states\x18\x01 \x03(\v2\".JoystickControl.GamepadInputStateR\finputsStates\"Y\n" +
	"\x17GetTransmitterStreamReq\x12>\n" +
	"\vtransmitter\x18\x01 \x01(\v2\x1c.JoystickControl.TransmitterR\vtransmitter\"V\n" +
	"\x13TransmitterChannels\x12?\n" +
	"\bchannels\x18\x01 \x03(\v2#.JoystickControl.TransmitterChannelR\bchannels\"`\n" +
	"\x12TransmitterChannel\x12%\n" +
	"\x0echannel_number\x18\x01 \x01(\x05R\rchannelNumber\x12#\n" +
	"\rchannel_value\x18\x02 \x01(\x05R\fchannelValue\"7\n" +
	"\tEvalState\x12\x14\n" +
	"\x05isNaN\x18\x02 \x01(\bR\x05isNaN\x12\x14\n" +
	"\x05value\x18\x03 \x01(\x05R\x05value\"\xa4\x01\n" +
	"\n" +
	"EvalStates\x12?\n" +
	...
	"\battitude\x18\x02 \x01(\v2\x1d.JoystickControl.AttitudeDataH\x00R\battitude\x128\n" +
	"\abattery\x18\x03 \x01(\v2\x1c.JoystickControl.BatteryDataH\x00R\abattery\x12,\n" +
	"\x03gps\x18\x04 \x01(\v2\x18.JoystickControl.GPSDataH\x00R\x03gps\x12B\n" +
	"\vflight_mode\x18\x05 \x01(\v2\x1f.JoystickControl.FlightModeDataH\x00R\n" +
	"flightMode\x12/\n" +
	"\x04sync\x18\x06 \x01(\v2\x19.JoystickControl.SyncDataH\x00R\x04sync\x126\n" +
	"\alink_tx\x18\a \x01(\v2\x1b.JoystickControl.LinkTXDataH\x00R\x06linkTx\x126\n" +
	"\alink_rx\x18\b \x01(\v2\x1b.JoystickControl.LinkRXDataH\x00R\x06linkRx\x12>\n" +
	"\tbarometer\x18\t \x01(\v2\x1e.JoystickControl.BarometerDataH\x00R\tbarometer\x12A\n" +
	"\n" +
	"variometer\x18\n" +
	" \x01(\v2\x1f.JoystickControl.VariometerDataH\x00R\n" +
	"variometer\x12]\n" +
	"\x14barometer_variometer\x18\v \x01(\v2(.JoystickControl.BarometerVariometerDataH\x00R\x13barometerVariometer\x12F\n" +
	"\vdevice_info\x18\f \x01(\v2#.JoystickControl.CRSFDeviceInfoDataH\x00R\n" +
	"deviceInfo\x12Y\n" +
	"\x12device_field_entry\x18\r \x01(\v2).JoystickControl.CRSFDeviceFieldEntryDataH\x00R\x10deviceFieldEntry\x12I\n" +
	"\fdevice_field\x18\x0e \x01(\v2$.JoystickControl.CRSFDeviceFieldDataH\x00R\vdeviceField\x12Y\n" +
	"\x12device_link_status\x18\x0f \x01(\v2).JoystickControl.CRSFDeviceLinkStatusDataH\x00R\x10deviceLinkStatusB\x06\n" +
	"\x04data\"\xce\x01\n" +
	"\x18CRSFDeviceLinkStatusData\x12*\n" +
	"\x11bad_packets_count\x18\x02 \x01(\rR\x0fbadPacketsCount\x12,\n" +
	"\x12good_packets_count\x18\x01 \x01(\rR\x10goodPacketsCount\x125\n" +
	"\x05flags\x18\x03 \x03(\x0e2\x1f.JoystickControl.LinkStatusFlagR\x05flags\x12!\n" +
	"\fwarning_info\x18\x04 \x01(\tR\vwarningInfo\"\xcd\x01\n" +
	"\x18CRSFDeviceFieldEntryData\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\rR\x02id\x12)\n" +
	"\x10chunks_remaining\x18\x02 \x01(\rR\x0fchunksRemaining\x12\x1b\n" +
	"\tparent_id\x18\x03 \x01(\rR\bparentId\x12A\n" +
	"\tdata_type\x18\x04 \x01(\x0e2$.JoystickControl.CRSFDeviceFieldTypeR\bdataType\x12\x16\n" +
	"\x06buffer\x18\x05 \x01(\fR\x06buffer\"\x81\x02\n" +
	"\x12CRSFDeviceInfoData\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\rR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12#\n" +
	"\rserial_number\x18\x03 \x01(\rR\fserialNumber\x12)\n" +
	"\x10hardware_version\x18\x04 \x01(\tR\x0fhardwareVersion\x12)\n" +
	"\x10software_version\x18\x05 \x01(\tR\x0fsoftwareVersion\x12\x1f\n" +
	"\vfield_count\x18\x06 \x01(\rR\n" +
	"fieldCount\x12+\n" +
	"\x11parameter_version\x18\a \x01(\rR\x10parameterVersion\"+\n" +
	"\rBarometerData\x12\x1a\n" +
	"\baltitude\x18\x01 \x01(\x02R\baltitude\"7\n" +
	"\x0eVariometerData\x12%\n" +
	"\x0evertical_speed\x18\x01 \x01(\x02R\rverticalSpeed\"\\\n" +
	"\x17BarometerVariometerData\x12\x1a\n" +
	"\baltitude\x18\x01 \x01(\x02R\baltitude\x12%\n" +
	"\x0evertical_speed\x18\x02 \x01(\x02R\rverticalSpeed\"$\n" +
	"\x0eFlightModeData\x12\x12\n" +
	"\x04mode\x18\x01 \x01(\tR\x04mode\"s\n" +
	"\n" +
	"branchName\"R\n" +
	"\x11GetCRSFDevicesRes\x12=\n" +
	"\adevices\x18\x01 \x03(\v2#.JoystickControl.CRSFDeviceInfoDataR\adevices\"V\n" +
	"\x16GetCRSFDeviceFieldsRes\x12<\n" +
	"\x06fields\x18\x01 \x03(\v2$.JoystickControl.CRSFDeviceFieldDataR\x06fields\"\xae\a\n" +
	"\x13CRSFDeviceFieldData\x12=\n" +
	"\x05uint8\x18\x01 \x01(\v2%.JoystickControl.CRSFDeviceFieldUint8H\x00R\x05uint8\x12:\n" +
	"\x04int8\x18\x02 \x01(\v2$.JoystickControl.CRSFDeviceFieldInt8H\x00R\x04int8\x12@\n" +
	"\x06uint16\x18\x03 \x01(\v2&.JoystickControl.CRSFDeviceFieldUint16H\x00R\x06uint16\x12=\n" +
	"\x05int16\x18\x04 \x01(\v2%.JoystickControl.CRSFDeviceFieldInt16H\x00R\x05int16\x12@\n" +
	"\x06uint32\x18\x05 \x01(\v2&.JoystickControl.CRSFDeviceFieldUint32H\x00R\x06uint32\x12=\n" +
	"\x05int32\x18\x06 \x01(\v2%.JoystickControl.CRSFDeviceFieldInt32H\x00R\x05int32\x12@\n" +
	"\x06uint64\x18\a \x01(\v2&.JoystickControl.CRSFDeviceFieldUint64H\x00R\x06uint64\x12=\n" +
	"\x05int64\x18\b \x01(\v2%.JoystickControl.CRSFDeviceFieldInt64H\x00R\x05int64\x12=\n" +
	"\x05float\x18\t \x01(\v2%.JoystickControl.CRSFDeviceFieldFloatH\x00R\x05float\x12M\n" +
	"\vtext_select\x18\n" +
	" \x01(\v2*.JoystickControl.CRSFDeviceFieldTextSelectH\x00R\n" +
	"textSelect\x12@\n" +
	"\x06string\x18\v \x01(\v2&.JoystickControl.CRSFDeviceFieldStringH\x00R\x06string\x12@\n" +
	"\x06folder\x18\f \x01(\v2&.JoystickControl.CRSFDeviceFieldFolderH\x00R\x06folder\x12:\n" +
	"\x04info\x18\r \x01(\v2$.JoystickControl.CRSFDeviceFieldInfoH\x00R\x04info\x12C\n" +
	"\acommand\x18\x0e \x01(\v2'.JoystickControl.CRSFDeviceFieldCommandH\x00R\acommandB\x06\n" +
	"\x04data\"\xfb\x01\n" +
	"\x14CRSFDeviceFieldUint8\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x128\n" +
	"\x04type\x18\x02 \x01(\x0e2$.JoystickControl.CRSFDeviceFieldTypeR\x04type\x12\x0e\n" +
	"\x02id\x18\x03 \x01(\rR\x02id\x12\x1b\n" +
	"\tparent_id\x18\x04 \x01(\rR\bparentId\x12\x14\n" +
	"\x05value\x18\x05 \x01(\rR\x05value\x12\x10\n" +
	"\x03min\x18\x06 \x01(\rR\x03min\x12\x10\n" +
	"\x03max\x18\a \x01(\rR\x03max\x12\x18\n" +
	"\adefault\x18\b \x01(\rR\adefault\x12\x14\n" +
	"\x05units\x18\t \x01(\tR\x05units\"\xfa\x01\n" +
	"\x13CRSFDeviceFieldInt8\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x128\n" +
	"\x04type\x18\x02 \x01(\x0e2$.JoystickControl.CRSFDeviceFieldTypeR\x04type\x12\x0e\n" +
	"\x02id\x18\x03 \x01(
	"\x15GetCRSFDeviceFieldReq\x12;\n" +
	"\x06device\x18\x01 \x01(\v2#.JoystickControl.CRSFDeviceInfoDataR\x06device\x12\x19\n" +
	"\bfield_id\x18\x02 \x01(\rR\afieldId\"U\n" +
	"\x16GetCRSFDeviceFieldsReq\x12;\n" +
	"\x06device\x18\x01 \x01(\v2#.JoystickControl.CRSFDeviceInfoDataR\x06device\"S\n" +
	"\x15GetCRSFDeviceFieldRes\x12:\n" +
	"\x05field\x18\x01 \x01(\v2$.JoystickControl.CRSFDeviceFieldDataR\x05field\"\x90\x01\n" +
	"\x15SetCRSFDeviceFieldReq\x12;\n" +
	"\x06device\x18\x01 \x01(\v2#.JoystickControl.CRSFDeviceInfoDataR\x06device\x12:\n" +
	"\x05field\x18\x02 \x01(\v2$.JoystickControl.CRSFDeviceFieldDataR\x05field\"S\n" +
	"\x15SetCRSFDeviceFieldRes\x12:\n" +
	"\x05field\x18\x01 \x01(\v2$.JoystickControl.CRSFDeviceFieldDataR\x05field\"h\n" +
	"\x1aGetCRSFDeviceLinkStatusRes\x12J\n" +
	"\vlink_status\x18\x01 \x01(\v2).JoystickControl.CRSFDeviceLinkStatusDataR\n" +
	"linkStatus*(\n" +
	"\x10GamepadInputType\x12\b\n" +
	"\x04AXIS\x10\x00\x12\n" +
	"\n" +
	"\x06BUTTON\x10\x01*E\n" +
	"\tPortState\x12\x0f\n" +
	"\vPortUnknown\x10\x00\x12\x14\n" +
	"\x10PortDisconnected\x10\x01\x12\x11\n" +
	"\rPortConnected\x10\x02*V\n" +
	...
	"\x05INT64\x10\a\x12\t\n" +
	"\x05FLOAT\x10\b\x12\x0f\n" +
	"\vTEXT_SELECT\x10\t\x12\n" +
	"\n" +
	"\x06STRING\x10\n" +
	"\x12\n" +
	"\n" +
	"\x06FOLDER\x10\v\x12\b\n" +
	"\x04INFO\x10\f\x12\v\n" +
	"\aCOMMAND\x10\r\x12\a\n" +
	"\x03VTX\x10\x0e\x12\n" +
	"\n" +
	"\x06STATUS\x10.\x12\x10\n" +
	"\fOUT_OF_RANGE\x10\x7f*w\n" +
	"\x1aCRSFDeviceFieldCommandStep\x12\b\n" +
	"\x04IDLE\x10\x00\x12\t\n" +
	"\x05CLICK\x10\x01\x12\r\n" +
	"\tEXECUTING\x10\x02\x12\x0f\n" +
	"\vASK_CONFIRM\x10\x03\x12\r\n" +
	"\tCONFIRMED\x10\x04\x12\n" +
	"\n" +
	"\x06CANCEL\x10\x05\x12\t\n" +
	"\x05QUERY\x10\x06*\x99\x01\n" +
	"\x0eLinkStatusFlag\x12\r\n" +
	"\tCONNECTED\x10\x00\x12\v\n" +
	"\aSTATUS1\x10\x01\x12\x0f\n" +
	"\vMODEL_MATCH\x10\x02\x12\f\n" +
	"\bIS_ARMED\x10\x03\x12\f\n" +
	"\bWARNING1\x10\x04\x12\x13\n" +
	"\x0fERROR_CONNECTED\x10\x05\x12\x12\n" +
	"\x0eERROR_BAUDRATE\x10\x06\x12\x15\n" +
	"\x11CRITICAL_WARNING2\x10\a2\xc3\r\n" +
	"\x0fJoystickControl\x12H\n" +
	"\vgetGamepads\x12\x16.JoystickControl.Empty\x1a\x1f.JoystickControl.GetGamepadsRes\"\x00\x12O\n" +
	"\x0fgetTransmitters\x12\x16.JoystickControl.Empty\x1a\".JoystickControl.GetTransmitterRes\"\x00\x12D\n" +
	"\tgetConfig\x12\x16.JoystickControl.Empty\x1a\x1d.JoystickControl.GetConfigRes\"\x00\x12D\n" +
	"\tsetConfig\x12\x1d.JoystickControl.SetConfigReq\x1a\x16.JoystickControl.Empty\"\x00\x12N\n" +
	"\x0evalidateConfig\x12\x16.JoystickControl.Empty\x1a\".JoystickControl.ValidateConfigRes\"\x00\x12D\n" +
	"\tstartLink\x12\x1d.JoystickControl.StartLinkReq\x1a\x16.JoystickControl.Empty\"\x00\x12<\n" +
	"\bstopLink\x12\x16.JoystickControl.Empty\x1a\x16.JoystickControl.Empty\"\x00\x12=\n" +
	"\tstartHTTP\x12\x16.JoystickControl.Empty\x1a\x16.JoystickControl.Empty\"\x00\x12<\n" +
	"\bstopHTTP\x12\x16.JoystickControl.Empty\x1a\x16.JoystickControl.Empty\"\x00\x12G\n" +
	"\rgetLinkStream\x12\x16.JoystickControl.Empty\x1a\x1a.JoystickControl.LinkState\"\x000\x01\x12L\n" +
	"\x12getTelemetryStream\x12\x16.JoystickControl.Empty\x1a\x1a.JoystickControl.Telemetry\"\x000\x01\x12H\n" +
	"\rgetEvalStream\x12\x16.JoystickControl.Empty\x1a\x1b.JoystickControl.EvalStates\"\x000\x01\x12j\n" +
	"\x14getTransmitterStream\x12(.JoystickControl.GetTransmitterStreamReq\x1a$.JoystickControl.TransmitterChannels\"\x000\x01\x12b\n" +
	"\x10getGamepadStream\x12$.JoystickControl.GetGamepadStreamReq\x1a$.JoystickControl.GamepadInputsStates\"\x000\x01\x12L\n" +
	"\x0egetCRSFDevices\x12\x16.JoystickControl.Empty\x1a\".JoystickControl.GetCRSFDevicesRes\x12i\n" +
	"\x13getCRSFDeviceFields\x12'.JoystickControl.GetCRSFDeviceFieldsReq\x1a'.JoystickControl.GetCRSFDeviceFieldsRes\"\x00\x12f\n" +
	"\x12getCRSFDeviceField\x12&.JoystickControl.GetCRSFDeviceFieldReq\x1a&.JoystickControl.GetCRSFDeviceFieldRes\"\x00\x12f\n" +
	"\x12setCRSFDeviceField\x12&.JoystickControl.SetCRSFDeviceFieldReq\x1a&.JoystickControl.SetCRSFDeviceFieldRes\"\x00\x12`\n" +
	"\x17getCRSFDeviceLinkStatus\x12\x16.JoystickControl.Empty\x1a+.JoystickControl.GetCRSFDeviceLinkStatusRes\"\x00\x12T\n" +
	" clearCRSFDeviceLinkCriticalFlags\x12\x16.JoystickControl.Empty\x1a\x16.JoystickControl.Empty\"\x00\x12F\n" +
	"\n" +
	"getAppInfo\x12\x16.JoystickControl.Empty\x1a\x1e.JoystickControl.GetAppInfoRes\"\x00B6Z4github.com/kaack/elrs-joystick-control/pkg/server/pbb\x06proto3"
...
func file_server_proto_init() {
	...
	file_server_proto_msgTypes[38].OneofWrappers = []any{
